public class TCPHandle: HandleType {
  ...
  public init(_ loop: Loop, _ uv_tcp_init: UVTCPInitOperation = UVTCPInit) {
    self.loop = loop
  ...
  public func bind(addr: Addr, _ uv_tcp_bind: UVTCPBindOperation = UVTCPBind, _ inet: INet = .AF) -> SUV.Status {
